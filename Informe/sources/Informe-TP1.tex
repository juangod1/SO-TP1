...
Debido a que el programa reserva los argumentos -t y -w para la ejecución de modo de testeo y modo de espera, no se puede tener un archivo con este nombre como primer parámetro ya que interpretará como primer argumento el modo de ejecución y no un archivo para \textit{hashear}.
